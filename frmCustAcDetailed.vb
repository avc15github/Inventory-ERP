...
Public Class frmCustAcDetailed
    Inherits System.Windows.Forms.Form

#Region " Windows Form Designer generated code "

    Public Sub New(ByVal strParty1 As String, ByVal strPartyNm1 As String, ByVal intMonthId1 As Integer, ByVal blnFlag1 As Boolean, ByVal strFromDt1 As String, ByVal strToDt1 As String)
        MyBase.New()
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label2.Size = New System.Drawing.Size(731, 25)
        ...
        Me.dtgPartyDtls.Size = New System.Drawing.Size(1068, 465)
        ...
        Me.lblFormCaption.Size = New System.Drawing.Size(1008, 25)
        Me.lblFormCaption.TabIndex = 0
        Me.lblFormCaption.Text = "Ledger On Screen"
        ...
        Me.dtpToDate.Value = New Date(2016, 8, 23, 0, 0, 0, 0)
        '
        'dtpFromDt
        '
        ...
        Me.dtpFromDt.Value = New Date(2016, 8, 23, 0, 0, 0, 0)
        '
        'Label28
        '
        ...
        Me.grpOSDtls.Size = New System.Drawing.Size(1064, 497)
        ...
        Me.lblOSFlag.Location = New System.Drawing.Point(717, 467)
        ...
        Me.lblOSTotAmt.Location = New System.Drawing.Point(415, 467)
        ...
        Me.lblOSAdjAmt.Location = New System.Drawing.Point(516, 467)
        ...
        Me.lblOSBalAmt.Location = New System.Drawing.Point(617, 467)
        ...
        Me.dtgOSDtls.Size = New System.Drawing.Size(1065, 447)
        ...
        Me.grpPymtDtl.Size = New System.Drawing.Size(1057, 459)
        ...
        Me.btnClose.Location = New System.Drawing.Point(975, 426)
        ...
        Me.dtgPymtDtl.Size = New System.Drawing.Size(1050, 420)
...
#End Region
    ...
    Private Sub frmCustAcDetailed_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub DisplayGridHeaders()
        ...
        With Grid
            ...
            .AddColumn("Type", GridColumnCreateAndFormat.enmTypeIdx.StringType, 0, "")
            .AddColumn("Vchr_Type", GridColumnCreateAndFormat.enmTypeIdx.StringType, 90, "Type")
            .AddColumn("CrossName", GridColumnCreateAndFormat.enmTypeIdx.StringType, 200, "Particulars")
            .AddColumn("Debit", GridColumnCreateAndFormat.enmTypeIdx.DecimalType, 120, "Debit.")
            .AddColumn("Credit", GridColumnCreateAndFormat.enmTypeIdx.DecimalType, 120, "Credit.")

            If chkShowBal.Checked = True Then
                .AddColumn("Closing", GridColumnCreateAndFormat.enmTypeIdx.DecimalType, 130, "Running Bal.")
                .AddColumn("Flag", GridColumnCreateAndFormat.enmTypeIdx.StringType, 30, "")
            Else
                .AddColumn("Closing", GridColumnCreateAndFormat.enmTypeIdx.DecimalType, 0, "Running Bal.")
                .AddColumn("Flag", GridColumnCreateAndFormat.enmTypeIdx.StringType, 0, "")
            End If

            .AddColumn("ChqNo", GridColumnCreateAndFormat.enmTypeIdx.StringType, 90, "Chq No")
            .AddColumn("Remark", GridColumnCreateAndFormat.enmTypeIdx.StringType, 220, "Remark")
            .AddColumn("Doc_Id", GridColumnCreateAndFormat.enmTypeIdx.IntegerType, 0, "Doc_Id")
            .AddColumn("CrossKey", GridColumnCreateAndFormat.enmTypeIdx.StringType, 0, "CrossKey")
    ...
    Private Sub dtgPartyAc_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtgPartyDtls.DoubleClick
        ...
        If dtgPartyDtls.Item(dtgPartyDtls.CurrentRowIndex, GridColumns.Doc_Id) > 0 Then
            If strType = "Vchr" Then
                ...
                Select Case dtgPartyDtls.Item(dtgPartyDtls.CurrentRowIndex, GridColumns.Vchr_Type)
                    Case "Payment"
    ...
    Private Sub DisplayFill()
        ...
        Select Case intMonthId
            'Case 1, 3, 5, 7, 8, 10, 12 ''Rohit 02032017
            Case 5, 7, 8, 10, 12
                dtFrom = CDate("01" & "/" & Format$(intMonthId, "00") & "/" & dtFrom.Year)
                dtTo = CDate("31" & "/" & Format$(intMonthId, "00") & "/" & dtFrom.Year)
            Case 2
                dtFrom = CDate("01" & "/" & Format$(intMonthId, "00") & "/" & dtTo.Year)
                dtTo = CDate("28" & "/" & Format$(intMonthId, "00") & "/" & dtTo.Year)
            Case 4, 6, 9, 11
                dtFrom = CDate("01" & "/" & Format$(intMonthId, "00") & "/" & dtFrom.Year)
                dtTo = CDate("30" & "/" & Format$(intMonthId, "00") & "/" & dtFrom.Year)
                ''Rohit 02032017
            Case 1, 3
                dtFrom = CDate("01" & "/" & Format$(intMonthId, "00") & "/" & dtTo.Year)
                dtTo = CDate("31" & "/" & Format$(intMonthId, "00") & "/" & dtTo.Year)
                ''End
        End Select
        ...
        If intMonthId <> 0 And intMonthId <> 4 Then
            ...
            '    & " From (Select A.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(dtFrom, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
            ...
            '    & " Where A.COBR_ID = '" & SelBranchId & "' and A.Fcyr_Id='" & SelYearId & "' and A.Led_Key ='" & strParty & "' And A.DOC_DT < '" & Format$(dtFrom, "MM/dd/yyyy") & "'" _
            '    & " Group by A.Led_Key, AmtFlag ) A " _
            ...
            '    & " Where A.COBR_ID = '" & SelBranchId & "' and A.Fcyr_Id='" & SelYearId & "' and A.Led_Key ='" & strParty & "'" _
            '    & " And A.DOC_DT Between '" & Format$(dtFrom, "MM/dd/yyyy") & "' And '" & Format$(dtTo, "MM/dd/yyyy") & "'" _
            '    & " ) B " _
            '    & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id, Cross_Ac, Led_Name  " _
            '    & " Order by Doc_dt "

            ''Rohit 10122018
            '    Query = Query & " Select Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, case when Sum(Amt) >= 0 then Sum(Amt)+isnull((Select Sum(isnull(Amt,0)) " _
            ...
            '        & " Where AB.COBR_ID = '" & SelBranchId & "'  and  AB.Fcyr_Id='" & SelYearId - 1 & "' and AB.Led_Key ='" & strParty & "'  And AB.DOC_DT < '" & Format$(AccFromDt, "MM/dd/yyyy") & "'" _
            '        & " Group by AB.Led_Key, AmtFlag ) B " _
            '        & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id   " _
            '& " ),0)  else 0 end Debit, " _
            '        & " case when Sum(Amt) < 0 then Sum(Amt)+isnull((Select Sum(isnull(Amt,0)) " _
            '        & " From (Select AB.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(AccFromDt, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
            ...
            '        & " Group by AB.Led_Key, AmtFlag ) B " _
            '        & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id   " _
            '& " ),0)  else 0 end Credit, ChqNo, Remark, Doc_Id, '' Cross_Ac, '' Led_Name " _
            '        & " From (Select A.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(dtFrom, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
            '        & " case when AmtFlag = 'D' then Sum(Amount) else -Sum(Amount) end Amt, '' ChqNo, '' Remark, 0 as Doc_Id  " _
            '        & " from View_LedgerOnScreen as A    " _
            '        & " Left Join Ledger Party	on A.Led_Key = Party.Led_Key   " _
            ...
            & " case when Sum(Amt) < 0  then Sum(Amt)  else 0 end Credit, ChqNo, Remark, Doc_Id, '' Cross_Ac, '' Led_Name " _
            & " From (Select A.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(dtFrom, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
            & " SUM(CASE WHEN AMTFLAG='D' THEN AMOUNT ELSE -AMOUNT END) Amt , '' ChqNo, '' Remark, 0 as Doc_Id  " _
            & " from View_LedgerOnScreen as A    " _
            & " Left Join Ledger Party	on A.Led_Key = Party.Led_Key   " _
            & " Where A.COBR_ID = '" & SelBranchId & "' and A.Led_Key ='" & strParty & "' And A.DOC_DT < '" & Format$(dtFrom, "MM/dd/yyyy") & "'" _
            & " Group by A.Led_Key) A " _
            & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id   " _
            & " Union All " _
            & " Select Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, Sum(Debit)Debit, Sum(Credit)Credit, ChqNo, Remark, Doc_Id, Cross_Ac, Led_Name   " _
            & " From (Select A.Led_Key Party_Key, A.Doc_dt, A.Doc_No, Trj_Type Type, Vchr_Type, case when AmtFlag = 'D' then Amount else 0 end Debit, " _
            ...
            '''End Rohit 10122018
            'Query = Query & " Select 0 MonthId, 'Opening' MNAME,  ABS(Sum(isnull(Amt,0))) Amt, Case When Sum(isnull(Amt,0))>=0  Then 'D' Else 'C' End AmtFlag,  0 SeqNo " _
            '    & " From (Select A.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(AccFromDt, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
            '    & " case when AmtFlag = 'D' then Sum(Amount) else -Sum(Amount) end Amt, '' ChqNo, '' Remark, 0 as Doc_Id  " _
            '    & " from View_LedgerOnScreen as A    " _
            '    & " Left Join Ledger Party	on A.Led_Key = Party.Led_Key   " _
            '    & " Where A.COBR_ID = '" & SelBranchId & "' and A.Fcyr_Id='" & SelYearId - 1 & "' and A.Led_Key ='" & strParty & "' And A.DOC_DT < '" & Format$(AccFromDt, "MM/dd/yyyy") & "'" _
            '    & " Group by A.Led_Key, AmtFlag ) A " _
            '    & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id   " _
            '    & " Union All " _
            '    & " Select Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, Sum(Debit)Debit, Sum(Credit)Credit, ChqNo, Remark, Doc_Id, Cross_Ac, Led_Name   " _
        ...
        Else
            ...
            'and A.Fcyr_Id='" & SelYearId - 1 & "'
            Query = Query & " Select  Party_Key, DATEADD(Day,-1,'04/01/2017') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type,  Case When Sum(isnull(Amt,0))>=0 Then Abs(Sum(isnull(Amt,0))) Else 0 End Debit  " _
               & " ,Case When Sum(isnull(Amt,0))<0 Then Abs(Sum(isnull(Amt,0))) Else 0 End Credit, '' ChqNo, '' Remark, 0 Doc_Id, '' Cross_Ac, '' Led_Name  From (Select A.Led_Key Party_Key, DATEADD(Day,-1,'" & Format$(AccFromDt, "MM/dd/yyyy") & "') Doc_dt, 'Op' Doc_No, 'Opening' Type, 'Opening' Vchr_Type, " _
               & " case when AmtFlag = 'D' then Sum(Amount) else -Sum(Amount) end Amt, '' ChqNo, '' Remark, 0 as Doc_Id  " _
               & " from View_LedgerOnScreen as A    " _
               & " Left Join Ledger Party	on A.Led_Key = Party.Led_Key   " _
               & " Where A.COBR_ID = '" & SelBranchId & "'  and A.Led_Key ='" & strParty & "' And A.DOC_DT < '" & Format$(AccFromDt, "MM/dd/yyyy") & "'" _
               & " Group by A.Led_Key, AmtFlag ) A " _
               & " Group by Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, ChqNo, Remark, Doc_Id   " _
               & " Union All " _
               & " Select Party_Key, Doc_dt, Doc_No, Type, Vchr_Type, Sum(Debit)Debit, Sum(Credit)Credit, ChqNo, Remark, Doc_Id, Cross_Ac, Led_Name  " _
        ...
        For Each PurRow In DtTable.Rows
            ...
            If PurRow("Type") = "Opening" Then
                ...
                NewRow(GridColumns.Vchr_Type) = PurRow("Vchr_Type") & ""
                NewRow(GridColumns.CrossName) = PurRow("Led_Name") & ""
                NewRow(GridColumns.Debit) = PurRow("Debit")
                NewRow(GridColumns.Credit) = Math.Abs(PurRow("Credit"))

                'If PurRow("Debit") > 0 Then
                '    OpBal = OpBal + PurRow("Debit")
                '    TotClosing = TotClosing + PurRow("Debit")
                '    NewRow(GridColumns.Closing) = Math.Abs(TotClosing)
                'Else
                '    OpBal = OpBal + PurRow("Credit")
                '    TotClosing = TotClosing - Math.Abs(PurRow("Credit"))
                '    NewRow(GridColumns.Closing) = Math.Abs(TotClosing)
                'End If


                OpBal = OpBal + PurRow("Debit") + PurRow("Credit")
                TotClosing = (TotClosing + PurRow("Debit")) - Math.Abs(PurRow("Credit"))
                NewRow(GridColumns.Closing) = Math.Abs(TotClosing)

                If TotClosing < 0 Then
                    NewRow(GridColumns.Flag) = "Cr"
                Else
                    NewRow(GridColumns.Flag) = "Dr"
                End If
                NewRow(GridColumns.ChqNo) = PurRow("ChqNo") & ""
                NewRow(GridColumns.Remark) = PurRow("Remark") & ""
                NewRow(GridColumns.Doc_Id) = PurRow("Doc_Id")
                NewRow(GridColumns.CrossKey) = PurRow("Cross_Ac") & ""
            ...
            Else
                ...
                'If PurRow("Debit") > 0 Then
                '    TotDebit = TotDebit + PurRow("Debit")
                '    TotClosing = TotClosing + PurRow("Debit")
                '    NewRow(GridColumns.Closing) = Math.Abs(TotClosing)
                'Else
                '    TotCredit = TotCredit + Math.Abs(PurRow("Credit"))
                '    TotClosing = TotClosing - Math.Abs(PurRow("Credit"))
                '    NewRow(GridColumns.Closing) = Math.Abs(TotClosing)
                'End If
        ...
        lblOpAmt.Text = Format$(Math.Abs(OpBal), "0.00")
        lblOpFlag.Text = IIf(OpBal >= 0, "Dr", "Cr")
        ...
        lblClFlag.Text = IIf(TotClosing >= 0, "Dr", "Cr")
